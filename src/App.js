    ...
    <div style={{ background: C.surface, border: `1px solid ${accent}20`, borderRadius: 14, padding: 16, marginBottom: 8 }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <div>
            <div style={labelStyle}>Sleep By</div>
            <input type="text" placeholder="23:00" style={{ ...inputStyle, width: "100%", boxSizing: "border-box" }} value={form.sleepTime || "23:00"} onChange={e => updateForm("sleepTime", e.target.value)} />
          </div>
          <div>
            <div style={labelStyle}>Wake At</div>
            <input type="text" placeholder="06:00" style={{ ...inputStyle, width: "100%", boxSizing: "border-box" }} value={form.wakeTime || "06:00"} onChange={e => updateForm("wakeTime", e.target.value)} />
          </div>
        </div>
