...
const HABITS = [
  ...
  { id: "h7a", label: "Meal 1 — Breakfast", category: "diet", type: "binary", icon: "◉" },
  { id: "h7b", label: "Meal 2 — Lunch", category: "diet", type: "binary", icon: "◉" },
{ id: "h7c", label: "Meal 3 — Pre-Workout", category: "diet", type: "binary", icon: "◉" },
{ id: "h7d", label: "Meal 4 — Post-Workout", category: "diet", type: "binary", icon: "◉" },
{ id: "h7e", label: "Meal 5 — Dinner", category: "diet", type: "binary", icon: "◉" },
{ id: "h7f", label: "Meal 6 — Before Bed", category: "diet", type: "binary", icon: "◉" },
